...
export const PACKAGES = {
  ...
  business: [
    { id: "day", name: "Content Day", price: 750, scope: "One shoot day · typically a half day", popular: true, get: ["A 60–90 second promo for anything you want to promote — a dish, an offer, a job well done", "Shot at your place — your people, your work, not stock footage", "Sized for your website, Instagram, Facebook, and TikTok", "One round of revisions", "Delivered within two weeks, ready to post"], includes: [] },
  ],
};
