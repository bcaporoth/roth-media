...
export const PACKAGES = {
  ...
  business: [
    { id: "mini", name: "Reel Day", price: 800, scope: "One shoot day · your feed, filled", get: ["8 vertical reels for Instagram, Facebook, and TikTok — shot in one visit", "Your best moments, your people, your place — not stock", "One round of revisions", "Delivered within two weeks, ready to post"], includes: [] },
...
export const ADDONS = {
  ...
  business: [
    { id: "promo2", name: "Promo video", price: 400, get: "A 60–90 second brand video cut from the same shoot — for your website and ads (or a second one for a different offer)" },
